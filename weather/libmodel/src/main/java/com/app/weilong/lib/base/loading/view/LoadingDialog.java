package com.app.weilong.lib.base.loading.view;
...
import com.app.weilong.lib.base.loading.StyleManager;
...
public class LoadingDialog implements FinishDrawListener {
    ...
    private static StyleManager s = new StyleManager(true, 0, Speed.SPEED_TWO, -1, -1, 500L,
            true, "加载中...", "加载成功", "操作失败");
...
//            LogUtils.error("ssssssssssssssssssssssssssss");

...
public class ScrollPickerView extends RecyclerView {
    ...
    public void doDraw(Canvas canvas) {
        if (mItemHeight > 0) {
            ...
            int startX = screenX / 2 - mItemWidth / 2 - SizeUtils.dp2Pix(mCtx,5);
            int stopX = mItemWidth + startX + SizeUtils.dp2Pix(mCtx,5);
    ...
    private void initPaint() {
        if (mBgPaint == null) {
            ...
            mBgPaint.setStrokeWidth(SizeUtils.dp2Pix(mCtx,1));
        }
    }

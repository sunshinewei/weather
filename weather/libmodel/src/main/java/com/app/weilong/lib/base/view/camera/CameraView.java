 ...
 */
package com.app.weilong.lib.base.view.camera;
...
import com.app.weilong.lib.base.view.camera.util.DimensionUtil;
import com.app.weilong.lib.base.view.camera.util.ImageUtil;
                    ...
                    try {
                        ...
                        handler.post(new Runnable() {
                            ...
                            public void run() {
                                ...
                                LogUtils.error("handler---------------------->"+tempFile.getPath());



//                                Bitmap bitmap = crop(file, tempFile, rotation);
                                callback.onPictureTaken(tempFile.getAbsolutePath());

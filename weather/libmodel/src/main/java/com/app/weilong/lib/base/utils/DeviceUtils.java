...
public class DeviceUtils {
    ...
    public static boolean isAdbEnabled() {
        return Settings.Secure.getInt(
                MyApplication.getAppConext().getContentResolver(),
    ...
    private static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) MyApplication.getAppConext().getSystemService(WIFI_SERVICE);
...
//        }
    ...
    private static String getMacAddressByWifiInfo() {
        try {
            final WifiManager wifi = (WifiManager) MyApplication.getAppConext()
    ...
    public static boolean isEmulator() {
        ...
        String operatorName = "";
        TelephonyManager tm = (TelephonyManager) MyApplication.getAppConext().getSystemService(Context.TELEPHONY_SERVICE);
        if (tm != null) {
        ...
        boolean checkDial = intent.resolveActivity(MyApplication.getAppConext().getPackageManager()) == null;
        ...
        if (udid == null) {
            synchronized (DeviceUtils.class) {
                if (udid == null) {
                    ...
                    final String id =CacheUtils.newInstance().getAsString(KEY_UDID);
    ...
    public static boolean isSameDevice(final String uniqueDeviceId) {
        ...
        final String cachedId = CacheUtils.newInstance().getAsString(KEY_UDID);
    ...
    private static String saveUdid(String prefix, String id) {
        ...
        CacheUtils.newInstance().put(KEY_UDID, udid);
        return udid;
    }

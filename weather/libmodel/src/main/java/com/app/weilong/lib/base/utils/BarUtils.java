...
//        }
    ...
    public static int getActionBarHeight() {
        ...
        if (MyApplication.getAppConext().getTheme().resolveAttribute(android.R.attr.actionBarSize, tv, true)) {
    ...
    private static void invokePanels(final String methodName) {
        try {
            ...
            Object service = MyApplication.getAppConext().getSystemService("statusbar");
    ...
    public static boolean isSupportNavBar() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
            WindowManager wm = (WindowManager) MyApplication.getAppConext().getSystemService(Context.WINDOW_SERVICE);
        ...
        boolean menu = ViewConfiguration.get(MyApplication.getAppConext()).hasPermanentMenuKey();

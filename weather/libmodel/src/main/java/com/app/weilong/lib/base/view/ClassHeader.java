...
public class ClassHeader extends LinearLayout implements RefreshHeader {
    ...
    public ClassHeader(Context context, AttributeSet attrs) {
...
//        mProgressView.setImageDrawable(getResources().getDrawable(R.drawable.refresh_style));


        mArrowView.setImageDrawable(new ArrowDrawable());

        addView(mProgressView, ViewGroup.LayoutParams.WRAP_CONTENT,ViewGroup.LayoutParams.MATCH_PARENT);
...
//                mProgressView.setVisibility(GONE);//隐藏动画
                ...
                AnimationDrawable drawable=
                        (AnimationDrawable) mProgressView.getDrawable();
                drawable.start();

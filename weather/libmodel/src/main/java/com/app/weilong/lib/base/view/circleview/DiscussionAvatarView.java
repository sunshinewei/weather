package com.app.weilong.lib.base.view.circleview;
...
/**
 * create by weilong on 2020/4/21
...
public class DiscussionAvatarView extends ViewGroup {
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        if (array != null) {
            ...
            mFrameColor = array.getColor(R.styleable.DiscussionAvatarView_frameColor, Color.WHITE);

            mRadius = SizeUtils.dip2px(context, radius);
    ...
    public void initDatas(ArrayList<String> list) {
        ...
        for (int i = 0; i < size; i++) {
            ImageView iv = (ImageView) mInflater.inflate(R.layout.view_circler_image, this, false);
            if (mIsLastComplete) {
                GlideUtils.loadCircleImageView(mContext, list.get(i), iv, mIsShowFrame, mFrameColor);
            } else {
                GlideUtils.loadCircleImageView(mContext, list.get(size - i - 1), iv, mIsShowFrame, mFrameColor);
            }
            this.addView(iv);
        }
    }
    ...
    public void addData(String ava, DiscussionAvatarListener listener1) {
        ...
        dataNum=getChildCount();
        final ImageView iv = (ImageView) mInflater.inflate(R.layout.view_circler_image, this, false);
        GlideUtils.loadCircleImageView(mContext, ava, iv, mIsShowFrame, mFrameColor);
        if (mIsLastComplete) {
            this.addView(iv);
        } else {
            this.addView(iv, 0);

...
public class ScreenUtils {
    ...
    public static boolean isLandscape() {
        return MyApplication.getAppConext().getResources().getConfiguration().orientation
    ...
    public static boolean isScreenLock() {
        KeyguardManager km =
                (KeyguardManager) MyApplication.getAppConext().getSystemService(Context.KEYGUARD_SERVICE);
